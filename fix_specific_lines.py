...
def fix_specific_lines():
    ...
    fixes = {
        ...
        "tests/test_import_service.py": {198: fix_long_assignment},
        "tests/test_main.py": {202: fix_long_assignment},
        "tests/test_widgets.py": {225: fix_long_method_call, 490: fix_long_assignment},
    }
