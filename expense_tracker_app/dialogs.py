        ...
        if has_expenses:
            if is_duplicate:
                ...
                reply = QMessageBox.question(
                    ...
                    f"Category '{category}'\
                    appears to be a duplicate of '{normalized_category}'.\n\n"
                    f"Would you like to merge the\
    ...
    Expenses stay organized under '{normalized_category}'\n"
                ...
                if result == 0:  # Cancel
                    ...
                    confirm_reply = QMessageBox.question(
                        ...
                        {len(self.data_manager.expenses[category])}\
                        expense(s) to 'Uncategorized'?\n\n"
                        "⚠️ Expenses moved to Uncategorized\
                        will be harder to find and organize.",
